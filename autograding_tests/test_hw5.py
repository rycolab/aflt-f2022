...
def test_minimization_example_1_Rational():
    ...
    MFSA = FSA(Rational)
    MFSA.add_arc(MinimizeState([State('c'), State('e'), State('d')]), '1', MinimizeState([State('c'), State('e'), State('d')]), Rational(503/2145))
    MFSA.add_F(MinimizeState([State('c'), State('e'), State('d')]), Rational(431/1716))
    MFSA.add_arc(MinimizeState([State('b'), State('a')]), '1', MinimizeState([State('b'), State('a')]), Rational(24/143))
    MFSA.add_arc(MinimizeState([State('b'), State('a')]), '2', MinimizeState([State('c'), State('e'), State('d')]), Rational(23/130))
...
def test_minimization_example_2_Rational():
    ...
    MFSA = FSA(Rational)
    MFSA.add_arc(MinimizeState([State(2)]), 'a', MinimizeState([State(5)]), Rational(4803839602528529/72057594037927936))
    MFSA.add_arc(MinimizeState([State(2)]), 'b', MinimizeState([State(6), State(7)]), Rational(3602879701896397/36028797018963968))
    MFSA.add_arc(MinimizeState([State(11)]), 'a', MinimizeState([State(13)]), Rational(2573485501354569/36028797018963968))
    MFSA.add_arc(MinimizeState([State(14)]), 'd', MinimizeState([State(15)]), Rational(6004799503160661/72057594037927936))
    MFSA.add_arc(MinimizeState([State(9)]), 'a', MinimizeState([State(12)]), Rational(3602879701896397/36028797018963968))
    MFSA.add_arc(MinimizeState([State(9)]), 'b', MinimizeState([State(15)]), Rational(6004799503160661/72057594037927936))
    MFSA.add_arc(MinimizeState([State(6), State(7)]), 'a', MinimizeState([State(10)]), Rational(6374325626432087/36028797018963968))
    MFSA.add_arc(MinimizeState([State(6), State(7)]), 'b', MinimizeState([State(11)]), Rational(11354529969612887/72057594037927936))
    MFSA.add_arc(MinimizeState([State(8)]), 'a', MinimizeState([State(12)]), Rational(4803839602528529/72057594037927936))
    MFSA.add_arc(MinimizeState([State(3)]), 'a', MinimizeState([State(10)]), Rational(3275345183542179/36028797018963968))
    MFSA.add_arc(MinimizeState([State(3)]), 'b', MinimizeState([State(6), State(7)]), Rational(4803839602528529/72057594037927936))
    MFSA.add_arc(MinimizeState([State(10)]), 'a', MinimizeState([State(13)]), Rational(2573485501354569/36028797018963968))
    MFSA.add_arc(MinimizeState([State(10)]), 'b', MinimizeState([State(15)]), Rational(6004799503160661/72057594037927936))
    MFSA.add_arc(MinimizeState([State(1)]), 'a', MinimizeState([State(2)]), Rational(2573485501354569/36028797018963968))
    MFSA.add_arc(MinimizeState([State(1)]), 'b', MinimizeState([State(3)]), Rational(4803839602528529/72057594037927936))
    MFSA.add_arc(MinimizeState([State(1)]), 'c', MinimizeState([State(4)]), Rational(1385722962267845/18014398509481984))
    MFSA.set_I(MinimizeState([State(1)]), Rational(1385722962267845/18014398509481984))
    MFSA.add_arc(MinimizeState([State(13)]), 'b', MinimizeState([State(15)]), Rational(3275345183542179/36028797018963968))
    MFSA.add_arc(MinimizeState([State(5)]), 'a', MinimizeState([State(15)]), Rational(4803839602528529/72057594037927936))
    MFSA.add_arc(MinimizeState([State(5)]), 'b', MinimizeState([State(10)]), Rational(3602879701896397/36028797018963968))
    MFSA.add_F(MinimizeState([State(15)]), Rational(3275345183542179/36028797018963968))
    MFSA.add_arc(MinimizeState([State(12)]), 'a', MinimizeState([State(14)]), Rational(6004799503160661/72057594037927936))
    MFSA.add_arc(MinimizeState([State(12)]), 'c', MinimizeState([State(15)]), Rational(1385722962267845/18014398509481984))
    MFSA.add_arc(MinimizeState([State(4)]), 'a', MinimizeState([State(8)]), Rational(3275345183542179/36028797018963968))
    MFSA.add_arc(MinimizeState([State(4)]), 'b', MinimizeState([State(9)]), Rational(2573485501354569/36028797018963968))
...
def test_example_minimize_3_Rational():
    ...
    MFSA = FSA(Rational)
    MFSA.add_arc(MinimizeState([State(2)]), 'a', MinimizeState([State(5), State(6)]), Rational(3602879701896397/36028797018963968))
    MFSA.add_arc(MinimizeState([State(2)]), 'b', MinimizeState([State(5), State(6)]), Rational(3275345183542179/36028797018963968))
    MFSA.add_arc(MinimizeState([State(14)]), 'd', MinimizeState([State(15)]), Rational(2573485501354569/36028797018963968))
    MFSA.add_arc(MinimizeState([State(8), State(9)]), 'a', MinimizeState([State(12)]), Rational(12555489870245019/72057594037927936))
    MFSA.add_F(MinimizeState([State(15)]), Rational(3602879701896397/36028797018963968))
    MFSA.add_arc(MinimizeState([State(7)]), 'a', MinimizeState([State(10), State(11)]), Rational(3275345183542179/36028797018963968))
    MFSA.add_arc(MinimizeState([State(7)]), 'b', MinimizeState([State(10), State(11)]), Rational(2573485501354569/36028797018963968))
    MFSA.add_arc(MinimizeState([State(3)]), 'a', MinimizeState([State(10), State(11)]), Rational(2573485501354569/36028797018963968))
    MFSA.add_arc(MinimizeState([State(3)]), 'b', MinimizeState([State(7)]), Rational(1385722962267845/18014398509481984))
    MFSA.add_arc(MinimizeState([State(1)]), 'a', MinimizeState([State(2)]), Rational(6004799503160661/72057594037927936))
    MFSA.add_arc(MinimizeState([State(1)]), 'b', MinimizeState([State(3)]), Rational(1385722962267845/18014398509481984))
    MFSA.add_arc(MinimizeState([State(1)]), 'c', MinimizeState([State(4)]), Rational(6004799503160661/72057594037927936))
    MFSA.set_I(MinimizeState([State(1)]), Rational(3275345183542179/36028797018963968))
    MFSA.add_arc(MinimizeState([State(5), State(6)]), 'b', MinimizeState([State(10), State(11)]), Rational(3602879701896397/18014398509481984))
    MFSA.add_arc(MinimizeState([State(13)]), 'b', MinimizeState([State(15)]), Rational(3602879701896397/36028797018963968))
    MFSA.add_arc(MinimizeState([State(10), State(11)]), 'a', MinimizeState([State(13)]), Rational(10346731451599909/72057594037927936))
    MFSA.add_arc(MinimizeState([State(10), State(11)]), 'b', MinimizeState([State(15)]), Rational(5404319552844595/36028797018963968))
    MFSA.add_arc(MinimizeState([State(12)]), 'a', MinimizeState([State(14)]), Rational(3275345183542179/36028797018963968))
    MFSA.add_arc(MinimizeState([State(12)]), 'c', MinimizeState([State(15)]), Rational(4803839602528529/72057594037927936))
    MFSA.add_arc(MinimizeState([State(4)]), 'a', MinimizeState([State(8), State(9)]), Rational(6004799503160661/72057594037927936))
    MFSA.add_arc(MinimizeState([State(4)]), 'b', MinimizeState([State(8), State(9)]), Rational(6004799503160661/72057594037927936))
